 ...
 * <ul>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.AtributeValueImpl#getValueINT <em>Value INT</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.AtributeValueImpl#getValueDEC <em>Value DEC</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.AtributeValueImpl#getValueID <em>Value ID</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.AtributeValueImpl#getValueBOOL <em>Value BOOL</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.AtributeValueImpl#getValueSTRING <em>Value STRING</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.AtributeValueImpl#getValueDAY <em>Value DAY</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.AtributeValueImpl#getValueMONTH <em>Value MONTH</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.AtributeValueImpl#getValueYEAR <em>Value YEAR</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AtributeValueImpl extends MinimalEObjectImpl.Container implements AtributeValue
{
  ...
  {
    return XdiagramPackage.Literals.ATRIBUTE_VALUE;
  }
  ...
  public void setValueINT(int newValueINT)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.ATRIBUTE_VALUE__VALUE_INT, oldValueINT, valueINT));
  }
  ...
  public void setValueDEC(int newValueDEC)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.ATRIBUTE_VALUE__VALUE_DEC, oldValueDEC, valueDEC));
  }
  ...
  public void setValueID(String newValueID)
  {
    ...
    valueID = newValueID;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.ATRIBUTE_VALUE__VALUE_ID, oldValueID, valueID));
  }
  ...
  public void setValueBOOL(String newValueBOOL)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.ATRIBUTE_VALUE__VALUE_BOOL, oldValueBOOL, valueBOOL));
  }
  ...
  public void setValueSTRING(String newValueSTRING)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.ATRIBUTE_VALUE__VALUE_STRING, oldValueSTRING, valueSTRING));
  }
  ...
  public void setValueDAY(int newValueDAY)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.ATRIBUTE_VALUE__VALUE_DAY, oldValueDAY, valueDAY));
  }
  ...
  public void setValueMONTH(int newValueMONTH)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.ATRIBUTE_VALUE__VALUE_MONTH, oldValueMONTH, valueMONTH));
  }
  ...
  public void setValueYEAR(int newValueYEAR)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.ATRIBUTE_VALUE__VALUE_YEAR, oldValueYEAR, valueYEAR));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XdiagramPackage.ATRIBUTE_VALUE__VALUE_INT:
        return getValueINT();
      case XdiagramPackage.ATRIBUTE_VALUE__VALUE_DEC:
        return getValueDEC();
      case XdiagramPackage.ATRIBUTE_VALUE__VALUE_ID:
        return getValueID();
      case XdiagramPackage.ATRIBUTE_VALUE__VALUE_BOOL:
        return getValueBOOL();
      case XdiagramPackage.ATRIBUTE_VALUE__VALUE_STRING:
        return getValueSTRING();
      case XdiagramPackage.ATRIBUTE_VALUE__VALUE_DAY:
        return getValueDAY();
      case XdiagramPackage.ATRIBUTE_VALUE__VALUE_MONTH:
        return getValueMONTH();
      case XdiagramPackage.ATRIBUTE_VALUE__VALUE_YEAR:
        return getValueYEAR();
    }
