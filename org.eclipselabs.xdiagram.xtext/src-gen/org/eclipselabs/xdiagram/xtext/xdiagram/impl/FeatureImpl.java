 ...
 * <ul>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.FeatureImpl#getConditional <em>Conditional</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureImpl extends MinimalEObjectImpl.Container implements Feature
{
  ...
  {
    return XdiagramPackage.Literals.FEATURE;
  }
  ...
  public NotificationChain basicSetConditional(FeatureConditional newConditional, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XdiagramPackage.FEATURE__CONDITIONAL, oldConditional, newConditional);
  ...
  public void setConditional(FeatureConditional newConditional)
  {
    if (newConditional != conditional)
    {
      ...
      if (conditional != null)
        msgs = ((InternalEObject)conditional).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XdiagramPackage.FEATURE__CONDITIONAL, null, msgs);
      if (newConditional != null)
        msgs = ((InternalEObject)newConditional).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XdiagramPackage.FEATURE__CONDITIONAL, null, msgs);
      msgs = basicSetConditional(newConditional, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.FEATURE__CONDITIONAL, newConditional, newConditional));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XdiagramPackage.FEATURE__CONDITIONAL:
