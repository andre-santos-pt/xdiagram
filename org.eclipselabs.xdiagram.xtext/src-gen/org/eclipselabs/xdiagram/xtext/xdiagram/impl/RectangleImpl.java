 ...
 * <ul>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.RectangleImpl#isRectangle <em>Rectangle</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.RectangleImpl#isSquare <em>Square</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RectangleImpl extends ConnectableElementImpl implements Rectangle
{
  ...
  {
    return XdiagramPackage.Literals.RECTANGLE;
  }
  ...
  public void setRectangle(boolean newRectangle)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.RECTANGLE__RECTANGLE, oldRectangle, rectangle));
  }
  ...
  public void setSquare(boolean newSquare)
  {
    ...
    square = newSquare;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.RECTANGLE__SQUARE, oldSquare, square));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XdiagramPackage.RECTANGLE__RECTANGLE:
        return isRectangle();
      case XdiagramPackage.RECTANGLE__SQUARE:
        return isSquare();
    }
