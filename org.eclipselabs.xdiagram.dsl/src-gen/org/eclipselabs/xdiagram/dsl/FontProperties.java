...
public interface FontProperties extends Feature
{
   ...
   * @see #setFace(String)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getFontProperties_Face()
   * @model
   * @generated
   */
  String getFace();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.FontProperties#getFace <em>Face</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSize(int)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getFontProperties_Size()
   * @model
   * @generated
   */
  int getSize();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.FontProperties#getSize <em>Size</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setBold(boolean)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getFontProperties_Bold()
   * @model
   * @generated
   */
  boolean isBold();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.FontProperties#isBold <em>Bold</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getFontProperties_Italics()
   * @model
   * @generated
   */
  boolean isItalics();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.FontProperties#isItalics <em>Italics</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
