...
public interface Position extends Feature
{
   ...
   * @see #setX(int)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getPosition_X()
   * @model
   * @generated
   */
  int getX();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.Position#getX <em>X</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getPosition_XRelative()
   * @model
   * @generated
   */
  boolean isXRelative();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.Position#isXRelative <em>XRelative</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setY(int)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getPosition_Y()
   * @model
   * @generated
   */
  int getY();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.Position#getY <em>Y</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getPosition_YRelative()
   * @model
   * @generated
   */
  boolean isYRelative();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.Position#isYRelative <em>YRelative</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
