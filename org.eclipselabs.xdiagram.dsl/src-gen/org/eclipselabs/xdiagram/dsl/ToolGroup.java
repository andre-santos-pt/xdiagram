...
public interface ToolGroup extends EObject
{
   ...
   * @see #setName(String)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getToolGroup_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.ToolGroup#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getToolGroup_Description()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.ToolGroup#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
