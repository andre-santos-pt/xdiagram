...
public class LineWidthImpl extends FeatureImpl implements LineWidth
{
  ...
  {
    return DslPackage.Literals.LINE_WIDTH;
  }
  ...
  public void setWidth(int newWidth)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.LINE_WIDTH__WIDTH, oldWidth, width));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.LINE_WIDTH__WIDTH:
        return getWidth();
    }
