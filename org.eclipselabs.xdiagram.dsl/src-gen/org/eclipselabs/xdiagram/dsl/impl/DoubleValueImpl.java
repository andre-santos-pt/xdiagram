...
public class DoubleValueImpl extends ValueImpl implements DoubleValue
{
  ...
  {
    return DslPackage.Literals.DOUBLE_VALUE;
  }
  ...
  public void setValueInt(int newValueInt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.DOUBLE_VALUE__VALUE_INT, oldValueInt, valueInt));
  }
  ...
  public void setValueDecimal(int newValueDecimal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.DOUBLE_VALUE__VALUE_DECIMAL, oldValueDecimal, valueDecimal));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.DOUBLE_VALUE__VALUE_INT:
        return getValueInt();
      case DslPackage.DOUBLE_VALUE__VALUE_DECIMAL:
