...
public class EllipseImpl extends ConnectableElementImpl implements Ellipse
{
  ...
  {
    return DslPackage.Literals.ELLIPSE;
  }
  ...
  public void setEllipse(boolean newEllipse)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ELLIPSE__ELLIPSE, oldEllipse, ellipse));
  }
  ...
  public void setCircle(boolean newCircle)
  {
    ...
    circle = newCircle;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ELLIPSE__CIRCLE, oldCircle, circle));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.ELLIPSE__ELLIPSE:
        return isEllipse();
      case DslPackage.ELLIPSE__CIRCLE:
        return isCircle();
    }
