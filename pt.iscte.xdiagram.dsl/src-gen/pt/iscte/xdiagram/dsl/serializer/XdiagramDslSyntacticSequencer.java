...
public class XdiagramDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected XdiagramDslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (XdiagramDslGrammarAccess) access;
	 ...
	 *     (rule start) 'font' (ambiguity) ';' (rule start)
	 *     (rule start) 'font' (ambiguity) bold?='bold'
	 *     (rule start) 'font' (ambiguity) conditional=FeatureConditional
	 *     (rule start) 'font' (ambiguity) italics?='italics'
	 *     (rule start) 'font' (ambiguity) size=INT
	 */
