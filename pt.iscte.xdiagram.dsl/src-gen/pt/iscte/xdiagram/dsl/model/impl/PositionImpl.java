 ...
 * </p>
 * <ul>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.PositionImpl#getX <em>X</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.PositionImpl#isXRelative <em>XRelative</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.PositionImpl#getY <em>Y</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.PositionImpl#isYRelative <em>YRelative</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PositionImpl extends FeatureImpl implements Position
{
  ...
  {
    return ModelPackage.Literals.POSITION;
  }
  ...
  public void setX(int newX)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSITION__X, oldX, x));
  }
  ...
  public void setXRelative(boolean newXRelative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSITION__XRELATIVE, oldXRelative, xRelative));
  }
  ...
  public void setY(int newY)
  {
    ...
    y = newY;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSITION__Y, oldY, y));
  }
  ...
  public void setYRelative(boolean newYRelative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSITION__YRELATIVE, oldYRelative, yRelative));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModelPackage.POSITION__X:
        return getX();
      case ModelPackage.POSITION__XRELATIVE:
        return isXRelative();
      case ModelPackage.POSITION__Y:
        return getY();
      case ModelPackage.POSITION__YRELATIVE:
        return isYRelative();
    }
