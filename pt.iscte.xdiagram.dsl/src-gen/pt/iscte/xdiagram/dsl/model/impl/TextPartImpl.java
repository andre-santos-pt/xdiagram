 ...
 * </p>
 * <ul>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.TextPartImpl#getText <em>Text</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.TextPartImpl#isEditable <em>Editable</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.TextPartImpl#getModelAttribute <em>Model Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextPartImpl extends MinimalEObjectImpl.Container implements TextPart
{
  ...
  {
    return ModelPackage.Literals.TEXT_PART;
  }
  ...
  public void setText(String newText)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TEXT_PART__TEXT, oldText, text));
  }
  ...
  public void setEditable(boolean newEditable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TEXT_PART__EDITABLE, oldEditable, editable));
  }
  ...
  public EAttribute getModelAttribute()
  {
    if (modelAttribute != null && modelAttribute.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.TEXT_PART__MODEL_ATTRIBUTE, oldModelAttribute, modelAttribute));
      }
    }
  ...
  public void setModelAttribute(EAttribute newModelAttribute)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TEXT_PART__MODEL_ATTRIBUTE, oldModelAttribute, modelAttribute));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModelPackage.TEXT_PART__TEXT:
        return getText();
      case ModelPackage.TEXT_PART__EDITABLE:
        return isEditable();
      case ModelPackage.TEXT_PART__MODEL_ATTRIBUTE:
