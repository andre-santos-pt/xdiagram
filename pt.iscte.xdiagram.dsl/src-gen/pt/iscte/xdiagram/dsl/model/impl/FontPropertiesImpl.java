 ...
 * </p>
 * <ul>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.FontPropertiesImpl#getFace <em>Face</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.FontPropertiesImpl#getSize <em>Size</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.FontPropertiesImpl#isBold <em>Bold</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.FontPropertiesImpl#isItalics <em>Italics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FontPropertiesImpl extends FeatureImpl implements FontProperties
{
  ...
  {
    return ModelPackage.Literals.FONT_PROPERTIES;
  }
  ...
  public void setFace(String newFace)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FONT_PROPERTIES__FACE, oldFace, face));
  }
  ...
  public void setSize(int newSize)
  {
    ...
    size = newSize;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FONT_PROPERTIES__SIZE, oldSize, size));
  }
  ...
  public void setBold(boolean newBold)
  {
    ...
    bold = newBold;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FONT_PROPERTIES__BOLD, oldBold, bold));
  }
  ...
  public void setItalics(boolean newItalics)
  {
    ...
    italics = newItalics;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FONT_PROPERTIES__ITALICS, oldItalics, italics));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModelPackage.FONT_PROPERTIES__FACE:
        return getFace();
      case ModelPackage.FONT_PROPERTIES__SIZE:
        return getSize();
      case ModelPackage.FONT_PROPERTIES__BOLD:
        return isBold();
      case ModelPackage.FONT_PROPERTIES__ITALICS:
        return isItalics();
    }
