 ...
 * </p>
 * <ul>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.NodeImpl#getRootFigure <em>Root Figure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeImpl extends DiagramElementImpl implements Node
{
  ...
  public NotificationChain basicSetRootFigure(ConnectableElement newRootFigure, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.NODE__ROOT_FIGURE, oldRootFigure, newRootFigure);
  ...
  public void setRootFigure(ConnectableElement newRootFigure)
  {
    if (newRootFigure != rootFigure)
    {
      ...
      if (rootFigure != null)
        msgs = ((InternalEObject)rootFigure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.NODE__ROOT_FIGURE, null, msgs);
      if (newRootFigure != null)
        msgs = ((InternalEObject)newRootFigure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.NODE__ROOT_FIGURE, null, msgs);
      msgs = basicSetRootFigure(newRootFigure, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.NODE__ROOT_FIGURE, newRootFigure, newRootFigure));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ModelPackage.NODE__ROOT_FIGURE:
