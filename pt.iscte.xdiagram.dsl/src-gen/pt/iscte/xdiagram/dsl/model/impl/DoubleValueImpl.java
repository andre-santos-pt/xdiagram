 ...
 * </p>
 * <ul>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.DoubleValueImpl#getValueInt <em>Value Int</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.DoubleValueImpl#getValueDecimal <em>Value Decimal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleValueImpl extends ValueImpl implements DoubleValue
{
  ...
  {
    return ModelPackage.Literals.DOUBLE_VALUE;
  }
  ...
  public void setValueInt(int newValueInt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DOUBLE_VALUE__VALUE_INT, oldValueInt, valueInt));
  }
  ...
  public void setValueDecimal(int newValueDecimal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DOUBLE_VALUE__VALUE_DECIMAL, oldValueDecimal, valueDecimal));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModelPackage.DOUBLE_VALUE__VALUE_INT:
        return getValueInt();
      case ModelPackage.DOUBLE_VALUE__VALUE_DECIMAL:
