 ...
 * </p>
 * <ul>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.ColorImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link pt.iscte.xdiagram.dsl.model.impl.ColorImpl#getCustom <em>Custom</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColorImpl extends MinimalEObjectImpl.Container implements Color
{
  ...
  public void setDefault(DefaultColor newDefault)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR__DEFAULT, oldDefault, default_));
  }
  ...
  public CustomColor getCustom()
  {
    if (custom != null && custom.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.COLOR__CUSTOM, oldCustom, custom));
      }
    }
    return custom;
  }
  ...
  public void setCustom(CustomColor newCustom)
  {
    ...
    custom = newCustom;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR__CUSTOM, oldCustom, custom));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModelPackage.COLOR__DEFAULT:
        return getDefault();
      case ModelPackage.COLOR__CUSTOM:
