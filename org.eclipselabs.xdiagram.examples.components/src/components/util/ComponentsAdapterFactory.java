...
public class ComponentsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ComponentsSwitch<Adapter> modelSwitch =
		new ComponentsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSystem(components.System object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link components.Component <em>Component</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link components.System <em>System</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
