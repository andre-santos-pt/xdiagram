 ...
 * <ul>
 *   <li>{@link featuremodel.impl.FeatureImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link featuremodel.impl.FeatureImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link featuremodel.impl.FeatureImpl#getParent <em>Parent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureImpl extends AbstractFeatureImpl implements Feature {
	...
	public void setOptional(boolean newOptional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturemodelPackage.FEATURE__OPTIONAL, oldOptional, optional));
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this, FeaturemodelPackage.FEATURE__CONSTRAINTS);
		}
		return constraints;
	}
	...
	public AbstractFeature getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeaturemodelPackage.FEATURE__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(AbstractFeature newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturemodelPackage.FEATURE__PARENT, oldParent, parent));
	}
