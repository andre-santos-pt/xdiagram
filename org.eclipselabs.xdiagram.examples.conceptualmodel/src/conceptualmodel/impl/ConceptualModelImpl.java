 ...
 * <ul>
 *   <li>{@link conceptualmodel.impl.ConceptualModelImpl#getEntities <em>Entities</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConceptualModelImpl extends MinimalEObjectImpl.Container implements ConceptualModel {
	...
	public EList<Entity> getEntities() {
		if (entities == null) {
			entities = new EObjectContainmentEList<Entity>(Entity.class, this, ConceptualmodelPackage.CONCEPTUAL_MODEL__ENTITIES);
		}
		return entities;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConceptualmodelPackage.CONCEPTUAL_MODEL__ENTITIES:
