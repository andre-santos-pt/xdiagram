 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.FontStyleImpl#getStyles <em>Styles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FontStyleImpl extends FeatureImpl implements FontStyle
{
  ...
  {
    return MyDslPackage.Literals.FONT_STYLE;
  }
  ...
  public EList<FontStyleType> getStyles()
  {
    if (styles == null)
    {
      styles = new EDataTypeEList<FontStyleType>(FontStyleType.class, this, MyDslPackage.FONT_STYLE__STYLES);
    }
    return styles;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.FONT_STYLE__STYLES:
        return getStyles();
    }
