		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDecoratorAccess().getGroup_1_0(), "rule__Decorator__Group_1_0__0");
					...
					put(grammarAccess.getNodeAccess().getNameAssignment_6_1(), "rule__Node__NameAssignment_6_1");
					put(grammarAccess.getNodeAccess().getAttributesAssignment_7(), "rule__Node__AttributesAssignment_7");
					put(grammarAccess.getNodeAccess().getFiguresAssignment_8(), "rule__Node__FiguresAssignment_8");
					put(grammarAccess.getNodeAccess().getContainersAssignment_9(), "rule__Node__ContainersAssignment_9");
					put(grammarAccess.getNodeAccess().getAnchorsAssignment_10(), "rule__Node__AnchorsAssignment_10");
					...
					put(grammarAccess.getLinkAccess().getIconAssignment_5_1(), "rule__Link__IconAssignment_5_1");
					put(grammarAccess.getLinkAccess().getNameAssignment_6_1(), "rule__Link__NameAssignment_6_1");
					put(grammarAccess.getLinkAccess().getAttributesAssignment_7_0(), "rule__Link__AttributesAssignment_7_0");
					...
					put(grammarAccess.getDecoratorAccess().getPosAssignment_1_0_1(), "rule__Decorator__PosAssignment_1_0_1");
					put(grammarAccess.getDecoratorAccess().getSourceAssignment_1_1(), "rule__Decorator__SourceAssignment_1_1");
					put(grammarAccess.getDecoratorAccess().getTargetAssignment_1_2(), "rule__Decorator__TargetAssignment_1_2");
					put(grammarAccess.getDecoratorAccess().getMiddleAssignment_1_3(), "rule__Decorator__MiddleAssignment_1_3");
					put(grammarAccess.getDecoratorAccess().getPlacingStaticAssignment_3(), "rule__Decorator__PlacingStaticAssignment_3");
					put(grammarAccess.getDecoratorAccess().getPlacingDynamicAssignment_4(), "rule__Decorator__PlacingDynamicAssignment_4");
