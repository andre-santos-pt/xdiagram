 ...
 * <ul>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.TextValueImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipselabs.xdiagram.xtext.xdiagram.impl.TextValueImpl#getModelAttribute <em>Model Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextValueImpl extends FeatureImpl implements TextValue
{
  ...
  {
    return XdiagramPackage.Literals.TEXT_VALUE;
  }
  ...
  public void setText(String newText)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.TEXT_VALUE__TEXT, oldText, text));
  }
  ...
  public EAttribute getModelAttribute()
  {
    if (modelAttribute != null && modelAttribute.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XdiagramPackage.TEXT_VALUE__MODEL_ATTRIBUTE, oldModelAttribute, modelAttribute));
      }
    }
  ...
  public void setModelAttribute(EAttribute newModelAttribute)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XdiagramPackage.TEXT_VALUE__MODEL_ATTRIBUTE, oldModelAttribute, modelAttribute));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XdiagramPackage.TEXT_VALUE__TEXT:
        return getText();
      case XdiagramPackage.TEXT_VALUE__MODEL_ATTRIBUTE:
