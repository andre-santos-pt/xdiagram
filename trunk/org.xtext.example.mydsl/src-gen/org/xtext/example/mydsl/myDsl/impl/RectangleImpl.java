 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RectangleImpl#isRectangle <em>Rectangle</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RectangleImpl#isSquare <em>Square</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RectangleImpl extends ConnectableElementImpl implements Rectangle
{
  ...
  {
    return MyDslPackage.Literals.RECTANGLE;
  }
  ...
  public void setRectangle(boolean newRectangle)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RECTANGLE__RECTANGLE, oldRectangle, rectangle));
  }
  ...
  public void setSquare(boolean newSquare)
  {
    ...
    square = newSquare;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RECTANGLE__SQUARE, oldSquare, square));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.RECTANGLE__RECTANGLE:
        return isRectangle();
      case MyDslPackage.RECTANGLE__SQUARE:
        return isSquare();
    }
