 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.FontFaceImpl#getFace <em>Face</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FontFaceImpl extends FeatureImpl implements FontFace
{
  ...
  {
    return MyDslPackage.Literals.FONT_FACE;
  }
  ...
  public void setFace(FontFaceType newFace)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.FONT_FACE__FACE, oldFace, face));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.FONT_FACE__FACE:
        return getFace();
    }
