...
public interface CustomColor extends EObject
{
   ...
   * @see #setName(String)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getCustomColor_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.CustomColor#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setR(int)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getCustomColor_R()
   * @model
   * @generated
   */
  int getR();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.CustomColor#getR <em>R</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setG(int)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getCustomColor_G()
   * @model
   * @generated
   */
  int getG();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.CustomColor#getG <em>G</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setB(int)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getCustomColor_B()
   * @model
   * @generated
   */
  int getB();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.CustomColor#getB <em>B</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
