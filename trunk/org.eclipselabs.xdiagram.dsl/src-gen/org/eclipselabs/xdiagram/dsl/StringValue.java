...
public interface StringValue extends Value
{
   ...
   * @see #setNull(boolean)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getStringValue_Null()
   * @model
   * @generated
   */
  boolean isNull();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.StringValue#isNull <em>Null</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setValue(String)
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getStringValue_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.StringValue#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
