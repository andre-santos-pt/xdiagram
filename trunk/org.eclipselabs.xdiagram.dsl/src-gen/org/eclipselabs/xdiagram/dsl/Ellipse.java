...
public interface Ellipse extends ConnectableElement
{
   ...
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getEllipse_Ellipse()
   * @model
   * @generated
   */
  boolean isEllipse();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.Ellipse#isEllipse <em>Ellipse</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.xdiagram.dsl.DslPackage#getEllipse_Circle()
   * @model
   * @generated
   */
  boolean isCircle();
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.xdiagram.dsl.Ellipse#isCircle <em>Circle</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
