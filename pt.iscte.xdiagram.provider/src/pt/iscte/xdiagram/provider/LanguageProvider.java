...
import pt.iscte.xdiagram.provider.internal.ElementCreation;
import pt.iscte.xdiagram.provider.internal.FeatureHandlerChain;
import pt.iscte.xdiagram.provider.internal.handlers.AlignHandler;
import pt.iscte.xdiagram.provider.internal.handlers.AnchorHandler;
import pt.iscte.xdiagram.provider.internal.handlers.ColorHandler;
import pt.iscte.xdiagram.provider.internal.handlers.ContainsHandler;
import pt.iscte.xdiagram.provider.internal.handlers.CornerHandler;
import pt.iscte.xdiagram.provider.internal.handlers.FontHandler;
import pt.iscte.xdiagram.provider.internal.handlers.LayoutHandler;
import pt.iscte.xdiagram.provider.internal.handlers.LineStyleHandler;
import pt.iscte.xdiagram.provider.internal.handlers.LineWidthHandler;
import pt.iscte.xdiagram.provider.internal.handlers.PointHandler;
import pt.iscte.xdiagram.provider.internal.handlers.PositionHandler;
import pt.iscte.xdiagram.provider.internal.handlers.SizeHandler;
import pt.iscte.xdiagram.provider.internal.handlers.TextValueHandler;
import pt.iscte.xdiagram.provider.internal.handlers.TransparencyHandler;
import pt.iscte.xdiagram.provider.internal.handlers.VisibleHandler;
